                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="section_four_button_title">Section Four Button
                                                        Title</label>
                                                    <input type="text"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('section_one_image') is-invalid @enderror">
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$home_cms->section_one_value }}" width="120"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('section_two_imageone') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$home_cms->section_two_value_one }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('section_two_imagetwo') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$home_cms->section_two_value_two }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('section_two_imagethree') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$home_cms->section_two_value_three }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('section_three_image') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$home_cms->section_three_value }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                                    </div>
                                                </div>
