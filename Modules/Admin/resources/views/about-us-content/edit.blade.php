    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card p-1">
                <div class="card-body">
                    <!-- form start -->
                    <form method="POST" action="{{ route('about-cms.update', @$about_cms->id) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description" name="description" class="form-control tinymce @error('description') is-invalid @enderror">{{ old('description', @$about_cms->description) }}</textarea>
                                                    @error('description')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->aboutUs_value }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('about_image_one') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->aboutUs_value_one }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('about_image_two') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->aboutUs_value_two }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('work_overview_imageone') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->over_view_image_one }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('work_overview_imagetwo') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->over_view_image_two }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('work_overview_imagethree') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->over_view_image_three }}"
                                                            width="120" height="50" alt="Uploaded Image"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div
                                                        class="input-group @error('work_overview_imagefour') is-invalid @enderror">
                                                        <input type="file" class="form-control  file-preview"
                                                ...
                                                <div class="form-group  image-container-div">
                                                    <div class="image-container">
                                                        <img src="{{ @$about_cms->over_view_image_four }}" width="120"
                                                            height="50" alt="Uploaded Image" id="uploadedImage"
                                                            class="uploaded-image">
                                                    </div>
                                                </div>
