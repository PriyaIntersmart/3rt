...
@section('content')
    ...
    @endif
        ...
        <form method="POST" action="{{ route('structure-overview.update', $structure_cms->id) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group @error('section_one_image') is-invalid @enderror">
                                            <input type="file" class="form-control  file-preview" id="left_section_image"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group  image-container-div">
                                        <div class="image-container">
                                            <img src="{{ @$structure_cms->image_value_one }}" width="120"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group  image-container-div">
                                        <div class="image-container">
                                            <img src="{{ @$structure_cms->image_value_two }}" width="120"
                                                height="50" alt="Uploaded Image" id="uploadedImage"
                                                class="uploaded-image">
