...
@section('title', 'Edit Count Details')

@section('content')

    <form method="POST" action="{{ route('count-setting.update',base64_encode($count_setting->id)) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control count @error('count') is-invalid @enderror"
                                id="count" name="count" value="{{ old('count',$count_setting->count) }}">
                            @error('count')
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control subtitle @error('subtitle') is-invalid @enderror"
                                id="subtitle" name="subtitle" value="{{ old('subtitle',$count_setting->subtitle) }}">
                            @error('subtitle')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text_before_count @error('text_before_count') is-invalid @enderror"
                                id="text_before_count" name="text_before_count" value="{{ old('text_before_count',$count_setting->text_before_count) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text_after_count @error('text_after_count') is-invalid @enderror"
                                id="text_after_count" name="text_after_count" value="{{ old('text_after_count',$count_setting->text_after_count) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('sort_order', @$count_setting->sort_order) }}">
                            @error('sort_order')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="example-select"
                                name="status">
                                <option value="1" {{ old('status', @$count_setting->status) == '1' ? 'selected' : '' }}>
                                    Active
                                </option>
                                <option value="0" {{ old('status', @$count_setting->status) == '0' ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                            @error('status')
