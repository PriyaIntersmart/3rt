...
class AddressController extends Controller
{
    ...
    {
        $address=Address::all();
        return view('backend::address-managment.index',compact('address'));
    }
    ...
    {
        return view('backend::address-managment.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::address-managment.edit',compact('address'));
    }
