...
use Modules\Backend\Http\Requests\BannerAndMetaRequest;
...
class BannerAndMetaTagController extends Controller
{
    ...
    public function index(Request $request, )
    {
        ...
        return view('backend::banner-and-tags.index',compact('bannerandmeta'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::banner-and-tags.edit',compact('bannerandmetatags'));
    }
