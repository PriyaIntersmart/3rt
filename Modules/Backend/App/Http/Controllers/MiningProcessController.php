...
use Modules\Backend\Http\Requests\MiningProcessRequest;
...
$mining_process=Miningprocess::all();
        return view('backend::mining-process.index',compact('mining_process'));
    }
    ...
    {
        return view('backend::mining-process.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::mining-process.edit',compact('mining_process'));
    }
