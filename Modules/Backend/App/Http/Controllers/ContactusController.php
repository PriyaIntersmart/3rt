...
use Modules\Backend\Http\Requests\ContactusRequest;
...
class ContactusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend::contact-us.index',compact('location'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::contact-us.edit',compact('location'));
    }
