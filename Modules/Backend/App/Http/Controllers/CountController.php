...
class CountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend::count-setting.index',compact('count'));
    }
    ...
    {
        return view('backend::count-setting.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::count-setting.edit',compact('count_setting'));
    }
