...
use Modules\Backend\Http\Requests\KeyElementsRequest;
...
class KeyElementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend::key-elements.index',compact('key_elements'));
    }
    ...
    {
        return view('backend::key-elements.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend::key-elements.edit',compact('key_element'));
    }
